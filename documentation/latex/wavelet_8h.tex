...
\#define \hyperlink{wavelet_8h_a548f13fd7e1be5728f3e0985d8474287}{C\+\_\+\+S\+I\+G\+M\+A}~1.\+00000000000187941284040286940
...
\#define \hyperlink{wavelet_8h_a409924d27c555a15d03e0f529e855fa1}{K\+\_\+\+S\+I\+G\+M\+A}~1.\+52299797447126284361366292335e-\/08
...
\#define \hyperlink{wavelet_8h_ab7acaac3ed40230536a8ded3672b64b4}{D\+\_\+\+J}~0.\+0625
\item 
...
\item 
\hypertarget{wavelet_8h_ad4fda822ab4300f2d55d53fa81dacb44}{}\#define \hyperlink{wavelet_8h_ad4fda822ab4300f2d55d53fa81dacb44}{M\+A\+X\+\_\+\+F\+R\+E\+Q\+U\+E\+N\+C\+Y}~60.\+0\label{wavelet_8h_ad4fda822ab4300f2d55d53fa81dacb44}

\begin{DoxyCompactList}\small\item\em The maximum frequency that will be analyzed. \end{DoxyCompactList}\item 
\hypertarget{wavelet_8h_a3ad4d776137bc1c3306fcfa436a05620}{}\#define \hyperlink{wavelet_8h_a3ad4d776137bc1c3306fcfa436a05620}{M\+I\+N\+\_\+\+F\+R\+E\+Q\+U\+E\+N\+C\+Y}~2.\+0\label{wavelet_8h_a3ad4d776137bc1c3306fcfa436a05620}
...
\hypertarget{wavelet_8h_a5b2902836360750d67596b282a199099}{}\#define \hyperlink{wavelet_8h_a5b2902836360750d67596b282a199099}{M\+A\+G\+N\+I\+T\+U\+D\+E}(x,  y)~sqrt( (x $\ast$ x) + (y $\ast$ y) )\label{wavelet_8h_a5b2902836360750d67596b282a199099}
...
\item 
\hypertarget{wavelet_8h_a9f0441e319c9b5b26c840824aed77543}{}int {\bfseries Write\+File} (const double $\ast$data, const double $\ast$frequency, const int x, const int y, const char filename\mbox{[}$\,$\mbox{]})\label{wavelet_8h_a9f0441e319c9b5b26c840824aed77543}

\item 
int \hyperlink{wavelet_8h_a9b00619d5ca803805e3d0d8d68af44ac}{Write\+Gnuplot\+Script} (const char graph\+\_\+title\mbox{[}$\,$\mbox{]}, const char filename\mbox{[}$\,$\mbox{]})
\item 
int \hyperlink{wavelet_8h_af34e9c79943517bd3bbb7956223b8912}{Plot\+\_\+\+P\+N\+G} (double $\ast$data, double $\ast$periods, int num\+\_\+x, int num\+\_\+y, char graph\+\_\+title\mbox{[}$\,$\mbox{]}, const char filename\mbox{[}$\,$\mbox{]})
\begin{DoxyCompactList}\small\item\em Uses P\+N\+G\+Writer to plot the results of the Continuous Wavelet Transform. \end{DoxyCompactList}\item 
\hypertarget{wavelet_8h_a1ee22dd644c181eaf7152c5b76b44e0e}{}int {\bfseries Plot} (double $\ast$data, double $\ast$frequency, int num\+\_\+x, int num\+\_\+y, int plot\+\_\+type, char graph\+\_\+title\mbox{[}$\,$\mbox{]}, char filename\mbox{[}$\,$\mbox{]})\label{wavelet_8h_a1ee22dd644c181eaf7152c5b76b44e0e}

\item 
int \hyperlink{wavelet_8h_ac2b737fb61e896d2ab3194ebdeeef37e}{Write\+Debug} (const double $\ast$data, const int length, const int sampling\+\_\+frequency, const char $\ast$filename)
...
\item 
double \hyperlink{wavelet_8h_a43c77d17ccf4921378e62126d4170b00}{Complete\+Fourier\+Morlet} (double w, const double scale)
\begin{DoxyCompactList}\small\item\em Computes the Morlet Wavelet in the frequency domain. \end{DoxyCompactList}\item 
\hypertarget{wavelet_8h_a0202248d87a2460abf149a0307c904c0}{}double {\bfseries Complete\+Real\+Morlet} (double x, double scale)\label{wavelet_8h_a0202248d87a2460abf149a0307c904c0}

\item 
\hypertarget{wavelet_8h_ac50cf309b4de6fed9b89ca54b6bf9c5c}{}double {\bfseries Complete\+Complex\+Morlet} (double x, double scale)\label{wavelet_8h_ac50cf309b4de6fed9b89ca54b6bf9c5c}

\item 
\hypertarget{wavelet_8h_a6d9f89e34bbb934a29f17fa5d5d990c6}{}double {\bfseries C\+W\+T\+\_\+\+Cosine\+\_\+\+Real} (double time, double scale)\label{wavelet_8h_a6d9f89e34bbb934a29f17fa5d5d990c6}

\item 
\hypertarget{wavelet_8h_a9639604af355bcae9539bac014a2eb74}{}double {\bfseries C\+W\+T\+\_\+\+Cosine\+\_\+\+Complex} (double time, double scale)\label{wavelet_8h_a9639604af355bcae9539bac014a2eb74}

\item 
\hypertarget{wavelet_8h_ac7bb211b5b1096ed7a8652e8e04877bb}{}double {\bfseries C\+W\+T\+\_\+\+Dirac\+\_\+\+Real} (double time, double scale)\label{wavelet_8h_ac7bb211b5b1096ed7a8652e8e04877bb}

\item 
\hypertarget{wavelet_8h_a2054600abe2e6cff53edae319e2dd588}{}double {\bfseries C\+W\+T\+\_\+\+Dirac\+\_\+\+Complex} (double time, double scale)\label{wavelet_8h_a2054600abe2e6cff53edae319e2dd588}
...
\item 
double $\ast$ \hyperlink{wavelet_8h_a09c27fbf3c2f81918edd9c57169ca371}{Generate\+Scales} (const double minimum\+\_\+frequency, const double maximum\+\_\+frequency, const double s\+\_\+0)
...
double $\ast$ \hyperlink{wavelet_8h_a27394bc7ac779d93a58fa1a8e2230337}{Identify\+Frequencies} (double $\ast$scales, int count)
\begin{DoxyCompactList}\small\item\em Compute the corrosponding frequency to scales used. \end{DoxyCompactList}\item 
\hypertarget{wavelet_8h_a1598d73c74685d22ceff982cef27a992}{}void {\bfseries Convolute} (double $\ast$data, double $\ast$con\+Window, double $\ast$complex\+Window, int data\+\_\+size, int con\+Size, double $\ast$real\+Result, double $\ast$complex\+Result)\label{wavelet_8h_a1598d73c74685d22ceff982cef27a992}

\item 
\hypertarget{wavelet_8h_a7d26c4d60318630f9a90cbe21a7321b3}{}int {\bfseries C\+W\+T\+\_\+\+Convolution} (double $\ast$data, double $\ast$scales, int data\+\_\+size, int num\+\_\+of\+\_\+scales, double $\ast$result)\label{wavelet_8h_a7d26c4d60318630f9a90cbe21a7321b3}
...
\begin{DoxyCompactList}\small\item\em Analyzes the size of the F\+F\+T\+W arrays and generates the optimal plan. \end{DoxyCompactList}\item 
double \hyperlink{wavelet_8h_a2736a47ee392d4f7deaf502fdb706087}{Max} (double $\ast$array, int size)
\begin{DoxyCompactList}\small\item\em A function that finds the Maximum of a given array. \end{DoxyCompactList}\item 
double \hyperlink{wavelet_8h_afacff799d1ca8005dffa4de559338c55}{Min} (double $\ast$array, int size)
\begin{DoxyCompactList}\small\item\em A function that finds the minimum of a given array. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\subsubsection[{C\+\_\+\+S\+I\+G\+M\+A}]{\setlength{\rightskip}{0pt plus 5cm}C\+\_\+\+S\+I\+G\+M\+A~1.\+00000000000187941284040286940}\label{wavelet_8h_a548f13fd7e1be5728f3e0985d8474287}
...
\subsubsection[{D\+\_\+\+J}]{\setlength{\rightskip}{0pt plus 5cm}D\+\_\+\+J~0.\+0625}\label{wavelet_8h_ab7acaac3ed40230536a8ded3672b64b4}
...
\subsubsection[{K\+\_\+\+S\+I\+G\+M\+A}]{\setlength{\rightskip}{0pt plus 5cm}K\+\_\+\+S\+I\+G\+M\+A~1.\+52299797447126284361366292335e-\/08}\label{wavelet_8h_a409924d27c555a15d03e0f529e855fa1}
...
3 -\/ Repetion Padding
\begin{DoxyItemize}
\item The signal will be repeated once, in effect the signal length will be doubled.
\end{DoxyItemize}
...
\hline
\end{DoxyParams}
Takes a 1 x n array and preforms the Z-\/\+Score Calculation The array data will be rewritten \hypertarget{wavelet_8h_a43c77d17ccf4921378e62126d4170b00}{}\index{wavelet.\+h@{wavelet.\+h}!Complete\+Fourier\+Morlet@{Complete\+Fourier\+Morlet}}
\index{Complete\+Fourier\+Morlet@{Complete\+Fourier\+Morlet}!wavelet.\+h@{wavelet.\+h}}
\subsubsection[{Complete\+Fourier\+Morlet(double w, const double scale)}]{\setlength{\rightskip}{0pt plus 5cm}double Complete\+Fourier\+Morlet (
\begin{DoxyParamCaption}
\item[{const double}]{w, }
\item[{const double}]{scale}
\end{DoxyParamCaption}
)}\label{wavelet_8h_a43c77d17ccf4921378e62126d4170b00}
...
\hline
\end{DoxyParams}
Similar to \hyperlink{wavelet_8h_ab48098090bc3958e58e44ebec4a63f52}{Test\+Cases()} Sine Wave Sample
...
This function does not need to be used, but it can significantly improve performance if it is. \hypertarget{wavelet_8h_a09c27fbf3c2f81918edd9c57169ca371}{}\index{wavelet.\+h@{wavelet.\+h}!Generate\+Scales@{Generate\+Scales}}
...
\end{DoxyParamCaption}
)}\label{wavelet_8h_a09c27fbf3c2f81918edd9c57169ca371}
...
The Scales array will be allocated in this function, so it is wise to deallocate this array after it is used. \hypertarget{wavelet_8h_a27394bc7ac779d93a58fa1a8e2230337}{}\index{wavelet.\+h@{wavelet.\+h}!Identify\+Frequencies@{Identify\+Frequencies}}
...
\item[{int}]{count}
\end{DoxyParamCaption}
)}\label{wavelet_8h_a27394bc7ac779d93a58fa1a8e2230337}
...
It is wise to dealloate this array after use with the free() function. \hypertarget{wavelet_8h_a2736a47ee392d4f7deaf502fdb706087}{}\index{wavelet.\+h@{wavelet.\+h}!Max@{Max}}
\index{Max@{Max}!wavelet.\+h@{wavelet.\+h}}
\subsubsection[{Max(double $\ast$array, int size)}]{\setlength{\rightskip}{0pt plus 5cm}double Max (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{array, }
\item[{int}]{size}
\end{DoxyParamCaption}
)}\label{wavelet_8h_a2736a47ee392d4f7deaf502fdb706087}
...
\hline
\end{DoxyParams}
\hypertarget{wavelet_8h_afacff799d1ca8005dffa4de559338c55}{}\index{wavelet.\+h@{wavelet.\+h}!Min@{Min}}
\index{Min@{Min}!wavelet.\+h@{wavelet.\+h}}
\subsubsection[{Min(double $\ast$array, int size)}]{\setlength{\rightskip}{0pt plus 5cm}double Min (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{array, }
\item[{int}]{size}
\end{DoxyParamCaption}
)}\label{wavelet_8h_afacff799d1ca8005dffa4de559338c55}
...
\hline
\end{DoxyParams}
\hypertarget{wavelet_8h_af34e9c79943517bd3bbb7956223b8912}{}\index{wavelet.\+h@{wavelet.\+h}!Plot\+\_\+\+P\+N\+G@{Plot\+\_\+\+P\+N\+G}}
\index{Plot\+\_\+\+P\+N\+G@{Plot\+\_\+\+P\+N\+G}!wavelet.\+h@{wavelet.\+h}}
\subsubsection[{Plot\+\_\+\+P\+N\+G(double $\ast$data, double $\ast$periods, int num\+\_\+x, int num\+\_\+y, char graph\+\_\+title[], const char filename[])}]{\setlength{\rightskip}{0pt plus 5cm}int Plot\+\_\+\+P\+N\+G (
\begin{DoxyParamCaption}
\item[{double $\ast$}]{data, }
\item[{double $\ast$}]{periods, }
\item[{int}]{num\+\_\+x, }
\item[{int}]{num\+\_\+y, }
\item[{char}]{graph\+\_\+title\mbox{[}$\,$\mbox{]}, }
\item[{const char}]{filename\mbox{[}$\,$\mbox{]}}
\end{DoxyParamCaption}
)}\label{wavelet_8h_af34e9c79943517bd3bbb7956223b8912}


Uses P\+N\+G\+Writer to plot the results of the Continuous Wavelet Transform. 


\begin{DoxyParams}{Parameters}
{\em data} & An num\+\_\+x $\ast$ num\+\_\+y size data array that will be plotted \\
\hline
{\em periods} & A num\+\_\+y x 1 array of the frequency used to analyze the signal data \\
\hline
{\em num\+\_\+x} & The size of the data \\
\hline
{\em num\+\_\+y} & The number of frequencies analyzed \\
\hline
{\em graph\+\_\+title} & The title of the graph \\
\hline
{\em filename} & The name of the file that the data will be written to.\\
\hline
\end{DoxyParams}
This function plots a two dimentional array into a png using P\+N\+G\+Writer. It utilizes Get\+Range() and Get\+Colour() to function. In order to reduce the horizontal length of the image, a stride variable was introduced that will skip a certain number of elements in the data array. T\+He higher this number the slimmer the resultant graph will be.

The lines\+\_\+size plots the same pixel in a number of vertical columns. T\+His allows the vertical scaling to be increased and decreased. \hypertarget{wavelet_8h_aea1698ec0444b6a49c195c64c23dd2d5}{}\index{wavelet.\+h@{wavelet.\+h}!Read\+File@{Read\+File}}
...
7 &Frequency Sweep from M\+I\+N\+\_\+\+F\+R\+E\+Q\+U\+E\+N\+C\+Y to M\+A\+X\+\_\+\+F\+R\+E\+Q\+U\+E\+N\+C\+Y \\\cline{1-2}
\end{TabularC}
\centering
...
You can provide the function with scales of your choosing, or one can generate dyadic scales with the \hyperlink{wavelet_8h_a09c27fbf3c2f81918edd9c57169ca371}{Generate\+Scales()} function.

This function is optimized using openmp to allow for multi threading. \hypertarget{wavelet_8h_ac2b737fb61e896d2ab3194ebdeeef37e}{}\index{wavelet.\+h@{wavelet.\+h}!Write\+Debug@{Write\+Debug}}
\index{Write\+Debug@{Write\+Debug}!wavelet.\+h@{wavelet.\+h}}
\subsubsection[{Write\+Debug(const double $\ast$data, const int length, const int sampling\+\_\+frequency, const char $\ast$filename)}]{\setlength{\rightskip}{0pt plus 5cm}int Write\+Debug (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\label{wavelet_8h_ac2b737fb61e896d2ab3194ebdeeef37e}
...
\hline
{\em sampling\+\_\+frequency} & How often the data array was sampled \\
\hline
...
-\/1 if unsuccessful
\end{DoxyReturn}
This function writes a 1 -\/ dimentional array to the disk, it\textquotesingle{}s useful when trying to quickly get the results from an array. \hypertarget{wavelet_8h_a9b00619d5ca803805e3d0d8d68af44ac}{}\index{wavelet.\+h@{wavelet.\+h}!Write\+Gnuplot\+Script@{Write\+Gnuplot\+Script}}
\index{Write\+Gnuplot\+Script@{Write\+Gnuplot\+Script}!wavelet.\+h@{wavelet.\+h}}
\subsubsection[{Write\+Gnuplot\+Script(const char graph\+\_\+title[], const char filename[])}]{\setlength{\rightskip}{0pt plus 5cm}int Write\+Gnuplot\+Script (
\begin{DoxyParamCaption}
\item[{const char}]{graph\+\_\+title\mbox{[}$\,$\mbox{]}, }
\item[{const char}]{filename\mbox{[}$\,$\mbox{]}}
\end{DoxyParamCaption}
)}\label{wavelet_8h_a9b00619d5ca803805e3d0d8d68af44ac}

\begin{DoxyParams}{Parameters}
{\em graph\+\_\+title} & The title that the graph should be in \\
\hline
{\em filename} & The name of the file that will be graphed\\
\hline
\end{DoxyParams}
This function will generate a file called \char`\"{}script.\+gplot\char`\"{} that will can be used to plot data generated using Write\+File() \begin{DoxyReturn}{Returns}
0 on success 
\end{DoxyReturn}
